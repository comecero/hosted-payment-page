...
app.config(['$httpProvider', '$routeProvider', '$locationProvider', '$provide', function ($httpProvider, $routeProvider, $locationProvider, $provide) {
    ...
    // Define routes
    $routeProvider.when("/docs", { templateUrl: "../getting-started/docs.html", reloadOnSearch: false, title: "Getting Started - Hosted Payment Page" });
    $routeProvider.when("/link-builder", { templateUrl: "../getting-started/link-builder.html", reloadOnSearch: false, title: "Link Builder - Hosted Payment Page" });
